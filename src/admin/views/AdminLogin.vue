<template>
  <div class="admin-login min-h-screen flex items-center justify-center bg-brand-50 px-4 py-8 sm:py-12">
    <div class="w-full max-w-5xl grid lg:grid-cols-[1.05fr_0.95fr] bg-white rounded-[2rem] shadow-float overflow-hidden">
      ...
      <div class="p-7 sm:p-12 lg:p-14 flex items-center">
        <div class="w-full max-w-sm mx-auto">
          <div class="mb-9">
            <div class="w-12 h-12 rounded-2xl bg-brand-500 text-white flex items-center justify-center font-display text-lg font-bold mb-6">AT</div>
          ...
          <v-form class="space-y-5" @submit.prevent="handleLogin">
            <div>
